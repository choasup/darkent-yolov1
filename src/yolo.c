...
{
    char *train_images = "/home/data/liuyong/choas/method/darknet_v1/data/voc/train.txt";
    char *backup_directory = "/home/data/liuyong/choas/method/darknet_v1/backup";
    srand(time(0));
    data_seed = time(0);
...
void validate_yolo(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("/home/data/liuyong/choas/method/darknet_v1/data/voc/2007_test.txt");
